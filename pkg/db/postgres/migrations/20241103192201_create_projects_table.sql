...
VALUES
    ('Shortener-URL',
'Сокращатель ссылок - это проект, разработанный мною как часть моей учебной программы Яндекс Практикума.
    ...
    ('PrivateKeeperV2',
'Private Keeper V2 — это выпускной проект Яндекс Практикума.
